...
public class AdminController {
    ...
    public String orders(Model model, @RequestParam(required = false, defaultValue = "") String filter) {
        model.addAttribute("filter", filter);
        model.addAttribute("orders", orderService.getOrders(filter));
        return "admin/orders/orders";
    }

    @PostMapping("/admin/orders/{orderId}/changeStatus")
    public String changeOrderStatus(@PathVariable int orderId, Status newStatus) {
