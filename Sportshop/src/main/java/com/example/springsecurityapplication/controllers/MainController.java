...
public class MainController {
    ...
    public MainController(PersonValidator personValidator, PersonService personService, ProductService productService, CartService cartService, OrderRepository orderRepository) {
...
//    }
    ...
    public String cart(Model model){
        ...
        List<Cart> cartList = cartService.getCartsByPersonId(id_person);
